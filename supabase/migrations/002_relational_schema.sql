...
CREATE TABLE IF NOT EXISTS europanel.site_activities (
  ...
  submission_id  BIGINT NOT NULL REFERENCES europanel.submissions(id) ON DELETE CASCADE,
  code           TEXT NOT NULL,
  list_code      TEXT GENERATED ALWAYS AS ('site_activities') STORED,
  present        TEXT,
  ippc           TEXT,
  capacity       NUMERIC,
...
CREATE TABLE IF NOT EXISTS europanel.raw_material_storage (
  ...
  submission_id  BIGINT NOT NULL REFERENCES europanel.submissions(id) ON DELETE CASCADE,
  code           TEXT NOT NULL,
  list_code      TEXT GENERATED ALWAYS AS ('storage_types') STORED,
  pct            NUMERIC,
  cap            NUMERIC,
  area           NUMERIC,
  UNIQUE (submission_id, code),
...
CREATE TABLE IF NOT EXISTS europanel.wood_prep_operations (
  ...
  submission_id  BIGINT NOT NULL REFERENCES europanel.submissions(id) ON DELETE CASCADE,
  code           TEXT NOT NULL,
  list_code      TEXT GENERATED ALWAYS AS ('wood_prep_stages') STORED,
  process_desc   TEXT,
  prod_t_batch   TEXT,
  wood_dry       TEXT,
  airflow        TEXT,
...
CREATE TABLE IF NOT EXISTS europanel.raw_materials (
  ...
  submission_id  BIGINT NOT NULL REFERENCES europanel.submissions(id) ON DELETE CASCADE,
  code           TEXT NOT NULL,
  list_code      TEXT GENERATED ALWAYS AS ('raw_materials') STORED,
  pct            NUMERIC,
  species        TEXT,
  source         TEXT,
  UNIQUE (submission_id, code),
...
CREATE TABLE IF NOT EXISTS europanel.waste_water_pollutants (
  ...
  code                       TEXT NOT NULL,
  list_code                  TEXT GENERATED ALWAYS AS ('ww_pollutants') STORED,
  conc                       NUMERIC,
  freq                       TEXT,
  pos                        TEXT,
  comments                   TEXT,
